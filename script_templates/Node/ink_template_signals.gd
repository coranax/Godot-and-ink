...
_TS__ink_player.loaded.connect(_story_loaded)
_TS__ink_player.continued.connect(_continued)
_TS__ink_player.prompt_choices.connect(_prompt_choices)
_TS__ink_player.ended.connect(_ended)
